...
// @LINE:10
private[this] lazy val controllers_Application_deleteGroup3 = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("groups/"),DynamicPart("id", """[^/]+"""),StaticPart("/delete"))))
